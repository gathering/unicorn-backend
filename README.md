...
If you make changes that require rebuilding the django container, you can use the following command. This most often occurs when making changes to the dockerfile itself or python dependencies.
...
Also, make sure to check that tests are passing with `make test`. Coverage is automatically checked, and can be opened in a browser by running `make coverage`.
