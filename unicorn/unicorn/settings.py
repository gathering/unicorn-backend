...
SOCIAL_AUTH_KEYCLOAK_CREW_AUTHORIZATION_URL = env(
    "SOCIAL_AUTH_KEYCLOAK_CREW_AUTHORIZATION_URL"
)
SOCIAL_AUTH_KEYCLOAK_CREW_ACCESS_TOKEN_URL = env(
    "SOCIAL_AUTH_KEYCLOAK_CREW_ACCESS_TOKEN_URL"
)
...
if SOCIAL_AUTH_KEYCLOAK_CREW_ENABLED:
    AUTHENTICATION_BACKENDS = (
        "accounts.backends.KeycloakCrewOAuth2",
    ) + AUTHENTICATION_BACKENDS
...
SOCIAL_AUTH_KEYCLOAK_PARTICIPANT_PUBLIC_KEY = env(
    "SOCIAL_AUTH_KEYCLOAK_PARTICIPANT_PUBLIC_KEY"
)
SOCIAL_AUTH_KEYCLOAK_PARTICIPANT_AUTHORIZATION_URL = env(
    "SOCIAL_AUTH_KEYCLOAK_PARTICIPANT_AUTHORIZATION_URL"
)
SOCIAL_AUTH_KEYCLOAK_PARTICIPANT_ACCESS_TOKEN_URL = env(
    "SOCIAL_AUTH_KEYCLOAK_PARTICIPANT_ACCESS_TOKEN_URL"
)
...
if SOCIAL_AUTH_KEYCLOAK_PARTICIPANT_ENABLED:
    AUTHENTICATION_BACKENDS = (
        "accounts.backends.KeycloakParticipantOAuth2",
    ) + AUTHENTICATION_BACKENDS
...
if SOCIAL_AUTH_WANNABE_APP_KEY and SOCIAL_AUTH_WANNABE_EVENT_NAME:
    AUTHENTICATION_BACKENDS = (
        "accounts.backends.WannabeAPIAuth",
    ) + AUTHENTICATION_BACKENDS
...
if SOCIAL_AUTH_GEEKEVENTS_EVENT_ID:
    AUTHENTICATION_BACKENDS = (
        "accounts.backends.GeekEventsSSOAuth",
    ) + AUTHENTICATION_BACKENDS
