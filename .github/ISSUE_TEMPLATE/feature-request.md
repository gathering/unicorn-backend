...
about: Propose a new Unicorn feature or enhancement
...
<!-- 
    ...
    https://github.com/zoodo/unicorn-api/discussions
...
<!--
    ...
    perspective of a Unicorn user who would benefit from the proposed
